...
"""
This script generates a release versions of FinBlock for different platforms
...
def main():
    ...
    parser = argparse.ArgumentParser(description="This script generates FinBlock extension for different platforms and/or an unpacked development environment.")
    ...
    def generateBrowserPackage(browser):
        ...
        if BROWSER_NAME == "Chrome" and os.environ.get("TRAVIS") != None:
            print(" > Generating FinBlock for " + BROWSER_NAME + "...")
        else:
            print(" > Generating FinBlock for " + BROWSER_NAME + "...", end="")
