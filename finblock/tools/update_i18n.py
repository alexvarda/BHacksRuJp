...
"""
Python 3 script for managing FinBlock translations in Chrome JSON format

It is intended for:
- downloading AdBlock language files from Crowdin
- downloading FinBlock language files from Crowdin
...
if os.environ.get("TRAVIS") == None:
    ...
    if os.path.exists(os.environ.get("HOME") + "/.cb_crowdin_key"):
        ...
        raise FileNotFoundError("File with FinBlock's API key wasn't found.")
...
# Download language archives for AdBlock and FinBlock projects
...
# Merge temporary FinBlock strings into temporary AdBlock strings
def mergeStrings():
    printBold("Merging FinBlock and AdBlock language files...")
