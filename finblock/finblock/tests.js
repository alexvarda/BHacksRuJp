(function() {
    ...
    function test_finblock() {
        ...
        assert_eq(finblock._fit(pic1, t1), expect1);
        assert_eq(finblock._fit(pic1, t2), expect2);
        assert_eq(finblock._fit(pic1, t3), expect3);
        ...
        assert_eq(finblock._fit(pic, t4), expect4);
