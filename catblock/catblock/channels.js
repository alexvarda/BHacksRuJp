...
class Channels {
    ...
    add(data) {
        ...
        var klass = null;
        switch (data.name) {
            case "TheCatsOfFinBlockUsersChannel": klass = TheCatsOfFinBlockUsersChannel;
                break;
...
// Channel pulling from a Flickr channel "The Cats of FinBlock users"
class TheCatsOfFinBlockUsersChannel extends FlickrPhotosetChannel {
    constructor() {
